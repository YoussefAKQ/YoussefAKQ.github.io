...
export default function Home() {
  return (
    <main className="relative flex min-h-screen flex-col py-4 md:py-6 items-center justify-center p-10 bg-slate-900 text-white">
      <div className="container max-w-3xl flex-1">
        <nav className="container sticky top-0 z-50 mb-1 flex w-full max-w-4xl items-center justify-between bg-slate-900 py-4 backdrop-blur-md dark:bg-slate-900 md:mx-[-25px] md:px-[25px]">
          <a href="https://youssefportfolio-rouge.vercel.app" className="text-white">YoussefAKQ</a>
          <div className="flex items-center space-x-3">
            <a
              href="https://github.com/YoussefAKQ"
              className="hover:bg-slate-800 hover:text-neutral-900 dark:hover:bg-slate-700 dark:hover:text-neutral-50"
            >
        ...
        <div className="container max-w-4xl flex-1 flex flex-col space-y-4 delay-100 duration-500 animate-in fade-in slide-in-from-bottom-4 fill-mode-backwards">
          ...
          <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
            <div className="relative flex flex-col rounded-md border-[1px] border-neutral-300 px-2 py-2 shadow-sm dark:border-neutral-800 hover:bg-slate-800 hover:text-neutral-900 dark:hover:bg-slate-700 dark:hover:text-neutral-50">
        ...
        <div className="container max-w-4xl flex-1 flex flex-col space-y-4 delay-100 duration-500 animate-in fade-in slide-in-from-bottom-4 fill-mode-backwards">
          <br />
          <b className="text-xl">Skills principales</b>
          <div className="grid grid-cols-2 gap-3 md:grid-cols-3 ">
            <div className="text-xs md:text-sm text-sm items-center justify-center relative flex flex-col rounded-md border-[1px] border-neutral-300 px-2 py-2 shadow-sm dark:border-neutral-800 hover:bg-slate-800 hover:text-neutral-900 dark:hover:bg-slate-700 dark:hover:text-neutral-50">
              Java
            </div>
            <div className="text-xs md:text-sm text-sm items-center justify-center relative flex flex-col rounded-md border-[1px] border-neutral-300 px-2 py-2 shadow-sm dark:border-neutral-800 hover:bg-slate-800 hover:text-neutral-900 dark:hover:bg-slate-700 dark:hover:text-neutral-50">
              Python
